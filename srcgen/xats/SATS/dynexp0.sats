...
(*
#symload prerr with prerr_q0arg
#symload fprint with fprint_q0arg
*)
//
fun
q0arg_make_node
...
(*
#symload prerr with prerr_sq0arg
#symload fprint with fprint_sq0arg
*)
//
fun
sq0arg_make_node
...
(*
#symload prerr with prerr_tq0arg
#symload fprint with fprint_tq0arg
*)
//
fun
tq0arg_make_node
...
(*
#symload prerr with prerr_ti0arg
#symload fprint with fprint_ti0arg
*)
//
fun
ti0arg_make_node
...
(*
#symload prerr with prerr_a0typ
#symload fprint with fprint_a0typ
*)
//
fun
a0typ_make_node
...
(*
#symload prerr with prerr_d0arg
#symload fprint with fprint_d0arg
*)
//
fun
d0arg_make_node
...
(*
#symload prerr with prerr_f0arg
#symload fprint with fprint_f0arg
*)
//
fun
f0arg_make_node
...
(*
#symload prerr with prerr_d0pat
#symload fprint with fprint_d0pat
*)
//
fun
d0pat_anno_opt
...
(*
#symload prerr with prerr_d0pat_RPAREN
#symload fprint with fprint_d0pat_RPAREN
*)
//
(* ****** ****** *)
//
...
(*
#symload prerr with prerr_labd0pat_RBRACE
#symload fprint with fprint_labd0pat_RBRACE
*)
//
(* ****** ****** *)
...
(*
#symload prerr with prerr_d0exp
#symload fprint with fprint_d0exp
*)
//
fun
d0exp_anno_opt
...
(*
#symload prerr with prerr_d0exp_RPAREN
#symload fprint with fprint_d0exp_RPAREN
*)
//
(* ****** ****** *)
//
...
(*
#symload prerr with prerr_labd0exp_RBRACE
#symload fprint with fprint_labd0exp_RBRACE
*)
//
(* ****** ****** *)
//
...
(*
#symload prerr with prerr_d0exp_THEN
#symload fprint with fprint_d0exp_THEN
*)
//
fun
print_d0exp_ELSE:
...
(*
#symload prerr with prerr_d0exp_ELSE
#symload fprint with fprint_d0exp_ELSE
*)
//
(* ****** ****** *)
//
...
(*
#symload prerr with prerr_endwhere
#symload fprint with fprint_endwhere
*)
//
(* ****** ****** *)
//
...
(*
#symload prerr with prerr_d0eclseq_WHERE
#symload fprint with fprint_d0eclseq_WHERE
*)
//
(* ****** ****** *)
//
...
(*
#symload prerr with prerr_f0unarrow
#symload fprint with fprint_f0unarrow
*)
//
(* ****** ****** *)
//
...
(*
#symload prerr with prerr_d0gua
#symload fprint with fprint_d0gua
*)
//
fun
d0gua_make_node
...
(*
#symload prerr with prerr_declmodopt
#symload fprint with fprint_declmodopt
*)
//
(* ****** ****** *)
//
...
(*
#symload prerr with prerr_teqd0expopt
#symload fprint with fprint_teqd0expopt
*)
//
fun
print_wths0expopt:
...
(*
#symload prerr with prerr_wths0expopt
#symload fprint with fprint_wths0expopt
*)
//
(* ****** ****** *)
//
...
(*
#symload prerr with prerr_v0aldecl
#symload fprint with fprint_v0aldecl
*)
//
(* ****** ****** *)
//
...
(*
#symload prerr with prerr_v0ardecl
#symload fprint with fprint_v0ardecl
*)
//
(* ****** ****** *)
//
...
(*
#symload prerr with prerr_f0undecl
#symload fprint with fprint_f0undecl
*)
//
(* ****** ****** *)
//
...
(*
#symload prerr with prerr_d0cstdecl
#symload fprint with fprint_d0cstdecl
*)
//
(* ****** ****** *)
...
(*
#symload prerr with prerr_d0ecl
#symload fprint with fprint_d0ecl
*)
//
fun
d0ecl_make_node
...
(*
#symload prerr with prerr_precopt
*)
//
(*
#symload fprint with fprint_precopt
#symload fprint with fprint_precmod
#symload fprint with fprint_signint
*)
//
(* ****** ****** *)
//
...
(*
#symload prerr with prerr_abstdf0
#symload fprint with fprint_abstdf0
*)
//
(* ****** ****** *)
//
...
(*
#symload prerr with prerr_wd0eclseq
#symload fprint with fprint_wd0eclseq
*)
//
(* ****** ****** *)
...
//
#symload print with print_abstdef
#symload prerr with prerr_abstdef
#symload fprint with fprint_abstdef
//
(* ****** ****** *)
//
fun
