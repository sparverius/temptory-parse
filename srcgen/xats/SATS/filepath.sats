...
fun compare_filepath_filepath
  (x1: filepath, x2: filepath):<> int//(Sgn)
//
#symload = with eq_filepath_filepath
#symload != with neq_filepath_filepath
#symload compare with compare_filepath_filepath
//
(* ****** ****** *)
...
//
#symload .full with filepath_get_full
//
(* ****** ****** *)
//
fun
