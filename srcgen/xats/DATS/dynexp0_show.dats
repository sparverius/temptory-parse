...
| D0Papps(d0ps) =>
  (
    show$val<list0(d0pat)>(g0ofg1(d0ps))
  )
  (* print!("D0Papps(", d0ps, ")") *)
//
| D0Psqarg
...
| d0eclseq_WHERE
  ...
  (
    ...
    //
    show(tok0);
    show$val<optn0(token)>(g0ofg1(opt1));
    prout("\n  ");
    show$val<list0(d0ecl)>(g0ofg1(d0cs));
    show(opt2)
  )
...
| D0Csexpdef
  ...
  (
    ...
    show(sid);
    spc();
    show$val<list0(s0marg)>(g0ofg1(arg));
    (* $showtype(res); *)
...
| D0Cfundecl
  ...
  (
    ...
    (* $showtype(res); *)
    show$val<list0(f0undecl)>(g0ofg1(d0cs))
  )
...
| D0Cimpdecl
  ...
  (
    ...
    spc();
    show(dqid);
    show$val<list0(ti0arg)>(g0ofg1(tias));
    show$val<list0(f0arg)>(g0ofg1(f0as));
    show(res0);
    spc();
    show(teq1);
    spc();
